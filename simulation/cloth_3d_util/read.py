...
from cloth_3d_util.util import loadInfo, zRotMatrix, proj, mesh2UV, uv_to_pixel
from cloth_3d_util.IO import readOBJ, readPC2Frame
...
class DataReader:
	...
	def read_human(self, sample, frame, absolute=True):
		...
		zRot = np.eye(3, dtype=np.float32)
		if absolute:
